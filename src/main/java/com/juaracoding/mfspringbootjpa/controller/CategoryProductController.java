...
Java Developer
Created on 2/13/2023 9:36 PM
@Last Modified 2/13/2023 9:36 PM
Version 1.0
*/

import com.juaracoding.mfspringbootjpa.configuration.OtherConfig;
import com.juaracoding.mfspringbootjpa.dto.CategoryProductDTO;
import com.juaracoding.mfspringbootjpa.handler.ResourceNotFoundException;
...
import com.juaracoding.mfspringbootjpa.service.CategoryProductService;
import com.juaracoding.mfspringbootjpa.utils.ConstantMessage;
import com.juaracoding.mfspringbootjpa.utils.CsvReader;
import com.juaracoding.mfspringbootjpa.utils.ExcelReader;
...
//        lsCPUpload = new ArrayList<CategoryProduct>();
        ...
        try {
            ...
            strExceptionArr[1]="csvToCategoryProduct(InputStream inputStream) --- LINE 496"+ex.getMessage()+" Error Record at Line "+intCatchErrorRecord;
